...
interface CompactTrimmedOutput {
...
function isCompactTrimmedOutput(value: unknown): value is CompactTrimmedOutput {
    return (
        typeof value === "object" &&
        value !== null &&
...
function CompactionTrimmedBlock({
    invocation,
    output
}: {
...
function MemoryWriteBlock({ invocation }: { invocation: ToolInvocation }) {
    const input = isRecord(invocation.input)
...
function MemoryReadBlock({ invocation }: { invocation: ToolInvocation }) {
    const input = isRecord(invocation.input)
...
function MemoryDeleteBlock({ invocation }: { invocation: ToolInvocation }) {
    const input = isRecord(invocation.input)
